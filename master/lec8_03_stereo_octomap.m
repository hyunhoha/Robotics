...
%     pcs = rmmissing(reshape(points3D, [], 3));
%     pcs = reshape(points3D, [], 3);
    ...
    cloud_affine = rmmissing(cloud_affine);
    
    insertPointCloud(map, [x y z quat], cloud_affine, 10);
    updateOccupancy(map,cloud_affine, obs);
